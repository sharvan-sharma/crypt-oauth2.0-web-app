...
import Brand from '../devComponents/BlackBrand'
    ...
    if (this.state.hasError) {
      ...
      return (<div className = 'fullscreen d-flex justify-content-center align-items-center bg-black text'>
                    <div className='col-12 col-lg-6 col-md-8 col-xl-4'>
                        <p className='d-flex justify-content-center'><Brand color='white'/></p>
                        ...
                        <p><Link to='/' className='btn btn-light'>Way To CryPt</Link></p>
                    </div>
      </div>)
    }
